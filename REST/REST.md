...
> HATEOAS는 [Richardson Maturity Model](Richardson%20Maturity%20Model.md)의 **Level 3**에 해당한다. 상세 내용은 해당 문서 참조.
...
> 현실적으로 "RESTful API"라 불리는 대다수 API는 **Richardson Maturity Model Level 2** 수준이다. 성숙도 모델 상세는 [Richardson Maturity Model](Richardson%20Maturity%20Model.md) 참조.
...
- [Richardson Maturity Model](Richardson%20Maturity%20Model.md)
