...
metadata:
  ...
  annotations:      # Ingress 리소스에 추가적인 메타데이터를 제공하는 주석들을 정의
    ...
    alb.ingress.kubernetes.io/group.name: mbp-api
    alb.ingress.kubernetes.io/healthcheck-path: /actuator/health
    alb.ingress.kubernetes.io/wafv2-acl-arn: arn:aws:wafv2:ap-northeast-2:854013278161:regional/webacl/megabird-dev-alb-acl/c3c48bba-0d3c-4650-9beb-a5813798b3c2

    # Green 테스트용: X-Deployment-Version: green 헤더로 preview 서비스 접근
    alb.ingress.kubernetes.io/conditions.dev-mbp-api-preview: |
      [
        {
          "field": "http-header",
          "httpHeaderConfig": {
